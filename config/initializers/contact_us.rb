...
ContactUs.setup do |config|
  ...
  config.mailer_from = "nooralnabirails@gmail.com"

  # Configure the e-mail address which should receive the contact form email notifications.
  config.mailer_to = "nooralnabirails@gmail.com"
  ...
  config.success_redirect = 'https://printer-services-3d-nooralnabi.c9users.io/'
